...
export { default as DListItem } from './DListItem.astro';
...
export { default as PhotoSwiper } from './PhotoSwiper.astro';
export { default as PhotoSwiperClient } from './PhotoSwiperClient.jsx';
